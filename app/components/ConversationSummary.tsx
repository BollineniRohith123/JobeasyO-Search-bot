    ...
    <div className="w-full max-w-4xl mx-auto fade-in">
      ...
      <div className="space-y-4">
        ...
        {profile.profile.additionalNotes && renderSection(
          ...
          <p className="text-blue-300 bg-blue-900/20 px-3 py-2 rounded-lg border border-blue-800/20">
            {profile.profile.additionalNotes}
          </p>,
          false,
          'delay-300'
        )}
      ...
      {/* Get Jobs Button - Bottom */}
      {onSearchJobs && (
        <div className="mt-8 fade-in-up delay-400">
          <button
            onClick={onSearchJobs}
            disabled={isSearchingJobs}
            className={`
              ...
              transition-all duration-300 group relative
              ${isSearchingJobs
                ? 'bg-blue-900/50 text-blue-300 cursor-not-allowed border border-blue-800/30'
                : 'bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 text-white hover:from-blue-500 hover:via-indigo-500 hover:to-blue-500 border border-blue-500/30 hover:shadow-lg'
              }
            `}
          >
            {isSearchingJobs ? (
